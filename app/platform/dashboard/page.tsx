...
export default function PlatformDashboardPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-bold text-slate-900">Platform Super Admin Dashboard</h1>
        <p className="text-sm text-slate-500 mt-0.5">Global tenant oversight & provisioning</p>
      </div>
