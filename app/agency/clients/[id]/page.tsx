...
export default function AgencyClientDetailPage() {
  ...
  if (!client) {
    return (
      <div className="space-y-6 text-left">
        ...
        <Link href="/agency/clients" className="text-blue-600 hover:underline text-sm">&larr; Back to Clients</Link>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 text-left">
      {/* Header */}
      <div>
        <Link href="/agency/clients" className="text-xs text-slate-500 hover:text-blue-600 font-medium transition-colors">&larr; Back to Clients</Link>
