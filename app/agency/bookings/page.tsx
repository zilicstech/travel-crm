          ...
          <div className="overflow-x-auto">
            <table className="data-table">
              ...
              <tbody>
                  ...
                  return (
                    <tr key={b.id} className={b.bookingStatus === 'Cancelled' ? 'opacity-60' : ''}>
                      <td>
                        ...
                        <Link href={`/agency/clients/${b.clientId}`} className="text-sm font-medium text-slate-600 hover:text-blue-600 transition-colors">
                      ...
                      <td className="text-right text-sm font-bold text-emerald-700">{formatINR(b.profit)}</td>
                      <td>
                ...
                {filtered.length === 0 && (
                  <tr><td colSpan={6} className="text-center py-12 text-sm text-slate-400">No bookings found for this filter.</td></tr>
                )}
              </tbody>
            </table>
          </div>
