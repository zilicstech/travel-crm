...
import { initialLeads, Lead, getClientById, getAgentById } from '@/lib/mockData';
...
import { Plus, Search, Plane, ChevronRight, UserPlus } from 'lucide-react';
                ...
                <tbody>
                  {filtered.map(lead => {
                    ...
                    return (
                      <tr key={lead.id}>
                        <td>
                          <Link href={`/agency/leads/${lead.id}`} className="font-medium text-slate-900 hover:text-blue-600 transition-colors">
                        ...
                        <td className="text-sm text-slate-600">{agent?.name || 'Unassigned'}</td>
                        <td><LeadStatusBadge status={lead.status} /></td>
                        <td className="text-right">
                          <Link href={`/agency/leads/${lead.id}`} className="text-slate-400 hover:text-blue-600 transition-colors">
