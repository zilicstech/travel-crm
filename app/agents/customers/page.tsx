            ...
            <>
              ...
              <div>
                ...
                <Input value={form.nationality} onChange={e => set('nationality', e.target.value)}
                  placeholder="e.g., Indian" className="h-10 text-sm" />
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <Input value={form.preferredAirline} onChange={e => set('preferredAirline', e.target.value)}
                    placeholder="e.g., Emirates" className="h-10 text-sm" />
                </div>
                <div>
            ...
            <>
              ...
              <div>
                ...
                <textarea value={form.notes} onChange={e => set('notes', e.target.value)}
                  placeholder="e.g., Referred by Sarah Jenkins. Interested in Europe trips. High budget."
              ...
              <div className="p-3 bg-slate-50 rounded-lg border border-slate-100 space-y-1.5">
                ...
                <div className="flex justify-between text-xs">
                  ...
                  <span className="font-semibold text-slate-900">{form.countryCode} {form.phone}</span>
                </div>
                <div className="flex justify-between text-xs">
        ...
        <div className="flex justify-between p-6 border-t border-slate-100 flex-shrink-0">
          {step > 1 ? (
            <Button variant="ghost" onClick={() => setStep(s => s - 1)}
              className="h-9 px-4 text-sm font-semibold text-slate-600">
              ...
              {filtered.map((customer) => (
                <tr key={customer.id} className="hover:bg-slate-50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-right">
                    <Link href={`/agents/customers/${customer.id}`}>
